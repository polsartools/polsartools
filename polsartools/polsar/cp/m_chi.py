...
@time_it
def m_chi(in_dir,   chi=45, psi=0, win=1, fmt="tif", cog=False, 
    ...
    This function implements the M-chi Decomposition for
    ...
    None
        ...
        1. Ps_m_chi: Surface scattering power component
        2. Pd_m_chi: Double-bounce scattering power component
        3. Pv_m_chi: Volume scattering power component
    ...
    output_filepaths = []
    if fmt == "bin":
        output_filepaths.append(os.path.join(in_dir, "Ps_m_chi.bin"))
        output_filepaths.append(os.path.join(in_dir, "Pd_m_chi.bin"))
        output_filepaths.append(os.path.join(in_dir, "Pv_m_chi.bin"))
        output_filepaths.append(os.path.join(in_dir, "m_cp.bin"))
        output_filepaths.append(os.path.join(in_dir, "chi_cp.bin"))        

    else:
        output_filepaths.append(os.path.join(in_dir, "Ps_m_chi.tif"))
        output_filepaths.append(os.path.join(in_dir, "Pd_m_chi.tif"))
        output_filepaths.append(os.path.join(in_dir, "Pv_m_chi.tif"))
        output_filepaths.append(os.path.join(in_dir, "m_cp.tif"))
        output_filepaths.append(os.path.join(in_dir, "chi_cp.tif"))      
...
def process_chunk_mchi(chunks, window_size, *args, **kwargs):
